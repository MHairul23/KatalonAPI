...
response1 = WS.sendRequest(findTestObject('RESTWebService/ListUser'))
...
//WS.sendRequestAndVerify(findTestObject('RESTWebService/Update'))

WS.sendRequest(findTestObject('RESTWebService/Update', [('Username') : value]))
